...
export default function Storefront() {
  ...
  useEffect(() => {
    ...
    const refreshCatalogue = async () => {
      ...
      if (brandingResult.status === 'fulfilled') { setLogoUrl(brandingResult.value.logo_url); setStoreContent({ custom_html: brandingResult.value.custom_html || '', custom_css: brandingResult.value.custom_css || '', secondary_image_url: brandingResult.value.secondary_image_url || null }); }
  ...
  return <div className="storefront" id="top">
    ...
    <main>
      ...
      {storeContent.secondary_image_url && <section className="store-secondary-image"><img src={storeContent.secondary_image_url} alt="Craft N Sofa collection" /></section>}{storeContent.custom_html && <section className="store-custom-block" dangerouslySetInnerHTML={{ __html: storeContent.custom_html }} />}{storeContent.custom_css && <style dangerouslySetInnerHTML={{ __html: storeContent.custom_css }} />}
