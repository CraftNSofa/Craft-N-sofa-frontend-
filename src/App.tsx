...
function StoreContentManager({ tags, content, onSaveContent, onUploadSecondary, onClearSecondary, onUploadBlockImage }: { tags: AdminTag[]; content: StoreContentData; onSaveContent: (content: StoreContentData) => Promise<void>; onUploadSecondary: (file: File, title: string) => Promise<void>; onClearSecondary: () => Promise<void>; onUploadBlockImage: (file: File, previousUrl?: string | null) => Promise<string> }) {
