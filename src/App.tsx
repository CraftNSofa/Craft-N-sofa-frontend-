...
import { clearStoreLogo, createExpense, deleteCategory, deleteProduct as deleteRemoteProduct, deleteStoreBanner, deleteTag, getCurrentUser, loadBanners, loadCategories, loadExpenses, loadOrders, loadProducts, loadStoreBranding, loadTags, saveStoreContent, uploadSecondaryStoreImage, clearSecondaryStoreImage, uploadStoreProductBanner, clearStoreProductBanner, signInAdmin, signOutAdmin, subscribeToOrders, updateOrderStatus as updateRemoteOrderStatus, upsertCategory, upsertTag, saveProduct as saveRemoteProduct, uploadProductImage, uploadCategoryImage, uploadStoreBanner, replaceStoreBannerAssets, uploadStoreLogo, savePromoCards as saveRemotePromoCards, uploadPromoCardImage, deletePromoCardImage, uploadStoreContentImage, deleteStoreContentImage } from './lib/commerce';
...
type StoreContentData = { custom_html: string; custom_css: string; secondary_image_url: string | null; secondary_image_title: string; product_banner_url: string | null; content_blocks: StoreContentBlock[] };
...
function App() {
  ...
  const [storeContent, setStoreContent] = useState<StoreContentData>({ custom_html: '', custom_css: '', secondary_image_url: null, secondary_image_title: 'Craft N Sofa collection', product_banner_url: null, content_blocks: [] });
...
function StoreContentManager({ tags, content, onSaveContent, onUploadSecondary, onClearSecondary, onUploadProductBanner, onClearProductBanner, onUploadBlockImage }: { tags: AdminTag[]; content: StoreContentData; onSaveContent: (content: StoreContentData) => Promise<void>; onUploadSecondary: (file: File, title: string) => Promise<void>; onClearSecondary: () => Promise<void>; onUploadProductBanner: (file: File) => Promise<void>; onClearProductBanner: () => Promise<void>; onUploadBlockImage: (file: File, previousUrl?: string | null) => Promise<string> }) {
