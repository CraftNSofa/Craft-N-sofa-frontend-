...
import { clearStoreLogo, createExpense, deleteCategory, deleteProduct as deleteRemoteProduct, deleteStoreBanner, deleteTag, getCurrentUser, loadBanners, loadCategories, loadExpenses, loadOrders, loadProducts, loadStoreBranding, loadTags, signInAdmin, signOutAdmin, subscribeToOrders, updateOrderStatus as updateRemoteOrderStatus, updateStoreBanner, upsertCategory, upsertTag, saveProduct as saveRemoteProduct, uploadProductImage, uploadStoreBanner, uploadStoreLogo } from './lib/commerce';
...
function StoreSettingsView({ logoUrl, banners, onChangeLogo, onAddBanner, onToggleBanner, onDeleteBanner, onRemove }: { logoUrl: string | null; banners: Banner[]; onChangeLogo: () => void; onAddBanner: () => void; onToggleBanner: (id: string, active: boolean) => Promise<void>; onDeleteBanner: (banner: Banner) => Promise<void>; onRemove: () => Promise<void> }) {
