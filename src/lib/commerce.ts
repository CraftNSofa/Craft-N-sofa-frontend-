...
const brandingFields = 'id,logo_url,custom_html,custom_css,secondary_image_url,secondary_image_title,product_banner_url,product_banner_title,content_blocks,promo_cards,updated_at';
